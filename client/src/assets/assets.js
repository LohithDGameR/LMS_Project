...
export const dummyTestimonial = [
  ...
  {
    name: "Pawan Reddy",
    role: "SWE 2 @ Accenture",
    image: assets.Pawan_reddy,
    rating: 4.5,
    feedback:
      "I've been using Imagify for nearly two years, primarily for Instagram, and it has been incredibly user-friendly, making my work much easier.",
  },
...
export const dummyDashboardData = {
  totalEarnings: 240.76,
  enrolledStudentsData: [
    {
      courseTitle: "Test Course Title",
      student: {
        _id: "user_2qQlvXyr02B4Bq6hT0Gvaa5fT9V",
        name: "Lohith kallapalli",
        imageUrl:
          "https://res.cloudinary.com/doxvwhc46/image/upload/v1747475798/20200611_202919_p8ppsy.png",
      },
    },
    {
      ...
      student: {
        ...
        name: "Kiran Kumar",
        imageUrl:
          "https://res.cloudinary.com/doxvwhc46/image/upload/v1747475569/kiran_profile_ge8w7b.jpg",
      },
    },
    {
      courseTitle: "Introduction to JavaScript",
      student: {
        _id: "user_2qQlvXyr02B4Bq6hT0Gvaa5fT9V",
        name: "Gonna Ganapathi Swamy",
        imageUrl:
          "https://res.cloudinary.com/doxvwhc46/image/upload/v1747475616/gana_Profile_md4tic.jpg",
      },
    },
    {
      courseTitle: "HTML & CSS tutorial for beginners",
      student: {
        _id: "user_2qQlvXyr02B4Bq6hT0Gvaa5fT9V",
        name: "Baba Sai",
        imageUrl:
          "https://res.cloudinary.com/doxvwhc46/image/upload/v1747475615/Baba_zineiz.jpg",
      },
    },
    {
      courseTitle: "Docker Crash Course for Absolute Beginners [NEW]",
      student: {
        _id: "user_2qQlvXyr02B4Bq6hT0Gvaa5fT9V",
        name: "Pawan Reddy",
        imageUrl:
          "https://res.cloudinary.com/doxvwhc46/image/upload/v1747475617/Pawan_reddy_ooqul1.jpg",
      },
    },
    {
      courseTitle: "HTML & CSS tutorial for beginners",
      student: {
        ...
        name: "Uday Basker",
        imageUrl:
          "https://res.cloudinary.com/doxvwhc46/image/upload/v1747475617/ub_eep6uz.jpg",
      },
    },
  ],
  totalCourses: 5,
...
export const dummyStudentEnrolled = [
  {
    ...
    courseTitle: "Test Course Title",
    purchaseDate: "2025-05-16T10:01:00.000Z",
  },
  {
    student: {
      _id: "user_2qQlvXyr02B4Bq6hT0Gvaa5fT9V",
    ...
    courseTitle: "Introduction to JavaScript",
    purchaseDate: "2025-05-17T10:01:00.000Z",
  },
  {
    student: {
      _id: "user_2qQlvXyr02B4Bq6hT0Gvaa5fT9V",
  ...
  },
  {
    ...
    courseTitle: "HTML & CSS tutorial for beginners",
    purchaseDate: "2025-05-18T11:03:42.931Z",
  },
  {
    student: {
      _id: "user_2qQlvXyr02B4Bq6hT0Gvaa5fT9V",
    ...
    courseTitle: "Docker Crash Course for Absolute Beginners [NEW]",
    purchaseDate: "2025-05-18T10:01:00.000Z",
  },
  {
    student: {
      _id: "user_2qQlvXyr02B4Bq6hT0Gvaa5fT9V",
...
export const dummyCourses = [
  {
    ...
    courseTitle: "MongoDB Tutorial for Beginners",
    courseDescription:
      "<h2>Explore the Power of MongoDB</h2><p>MongoDB is a flexible and scalable NoSQL database that's designed for modern applications. In this overview, you'll discover the core concepts of MongoDB, including document structure, collections, and basic operations.</p><p>This introduction is ideal for anyone interested in understanding NoSQL databases and how MongoDB can be used for data storage and retrieval in various projects. By the end, you'll grasp the fundamental principles of MongoDB and its advantages.</p><ul><li>Understand the core concepts of NoSQL databases</li><li>Learn about document-based data modeling</li><li>Discover how to perform basic database operations</li></ul>",
    coursePrice: 49.99,
    isPublished: true,
    discount: 20,
    courseContent: [
      {
        chapterId: "chapter1",
        chapterOrder: 1,
        chapterTitle: "What is MongoDB? and Installation",
        chapterContent: [
          {
            lectureId: "lecture1",
            lectureTitle: "What is MongoDB?",
            lectureDuration: 7,
            lectureUrl: "https://youtu.be/6DoLxeMlVTI?si=wZlZgz_UDinwhiD5",
            isPreviewFree: true,
            lectureOrder: 1,
          },
          {
            ...
            lectureDuration: 10,
            lectureUrl: "http://example.com/mongodb_installation", // Added a placeholder URL
            isPreviewFree: false,
            lectureOrder: 2,
          },
        ],
      },
      {
        ...
        chapterContent: [
          {
            lectureId: "lecture3",
            lectureTitle: "MongoDB Database Explained",
            lectureDuration: 3,
            lectureUrl: "https://youtu.be/dgyKo2McNhM?si=5h88MoSGGQJxMlNh",
            isPreviewFree: false,
            lectureOrder: 1,
          },
          {
            lectureId: "lecture4",
            lectureTitle: "How to Insert Documents",
            lectureDuration: 6,
            lectureUrl: "https://youtu.be/N_BrirrY1Mk?si=K9gN3JX-Vh_rqndb",
            isPreviewFree: false,
            lectureOrder: 2,
          },
          {
            lectureId: "lecture5",
            lectureTitle: "MongoDB Data Types Explained",
            lectureDuration: 5,
            lectureUrl: "https://youtu.be/SVYMUo0uork?si=quDOB2i5qaI4aiol",
            isPreviewFree: false,
            lectureOrder: 3,
          },
        ],
      },
      {
        chapterId: "chapter3",
        chapterOrder: 3,
        chapterTitle: "Querying in MongoDB",
        chapterContent: [
          {
            lectureId: "lecture6",
            lectureTitle: "Basic Queries",
            lectureDuration: 8,
            lectureUrl: "http://example.com/basic_queries",
            isPreviewFree: false,
            lectureOrder: 1,
          },
          {
            lectureId: "lecture7",
            lectureTitle: "Advanced Queries",
            lectureDuration: 12,
            lectureUrl: "http://example.com/advanced_queries",
            isPreviewFree: false,
            lectureOrder: 2,
          },
        ],
    ...
    __v: 4,
    courseThumbnail: "https://res.cloudinary.com/doxvwhc46/image/upload/v1747483633/MongoDB_fhkmwt.jpg",
    language: "English",
    category: "Databases",
    level: "Beginner",
    totalLectures: 7,
