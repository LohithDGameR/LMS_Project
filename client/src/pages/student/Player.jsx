...
const Player = () => {
  ...
  const getCourseData = () => {
    ...
    if (foundCourse) {
      ...
      const userRating = foundCourse.courseRatings.find(
  ...
  const handleRate = async (rating) => {
    try {
      ...
      if (data.success) {
        toast.success(data.message);
        fetchUserEnrolledCourses();
        getCourseData(); // Update course data to reflect the new rating
      } else {
        toast.error(data.message);
      }
    } catch (error) {
          ...
          {playerData ? (
            <div>
              <YouTube
                ...
                iframeClassName="w-full aspect-video" // Using Tailwind classes
              />
