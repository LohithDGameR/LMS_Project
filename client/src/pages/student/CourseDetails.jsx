      ...
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-center justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-800">
          ...
          <div className="flex items-center space-x-2 pt-3 pb-1 text-sm">
            ...
            <p>
              {courseData.enrolledStundents.length}
              {courseData.enrolledStundents.length > 1 ? "students" : "student"}
            </p>
          </div>
          <p className="text-sm">
            Course by <span className="text-blue-600">Lohith Kallapalli</span>
          </p>
        ...
        {/* right column */}
        <div className="max-w-couse-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          {playerData ? (
            <YouTube
              videoId={playerData.videoId}
              opts={{ playerVars: { autoplay: 1 } }}
              iframeClassName="wfull aspect-video"
            />
          ) : (
